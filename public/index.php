...
<img class="header-img" src="<?php echo url_for('assets/tools_header_img.jpg'); ?>" alt="misc tools" width="1600">
<div id="content">
  ...
  <div class="center">  
    <img src="<?php echo url_for('/assets/friends.jpeg')?>" alt="group of friends standing together" width="780"> 
    <h2>History</h2>
  </div>  
